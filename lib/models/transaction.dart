...
class Transaction {
  ...
  final TransactionSource source; // SMS or Notification
  final TransactionDirection direction;

  // Add these fields to your Transaction class
  final bool synced;
  ...
  String get formattedAmount =>
      '${direction == TransactionDirection.incoming ? '+' : '-'}${amount.toStringAsFixed(0)}₫';
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    return Transaction(
      ...
      source: json['source'] as TransactionSource,
      direction:
  ...
  static Transaction? fromSmsText(
  ...
  static double _extractAmount(String text) {
    ...
    final amountRegex =
        RegExp(r'([\d,.]+)(\s*)((VND|vnd|đ|\$))', multiLine: true);
  ...
  static String _extractDescription(String text) {
    ...
    final nameRegex = RegExp(r'(from|to|by|for|ref)\s+([A-Za-z0-9\s]+)',
        caseSensitive: false);
  ...
  List<String> toGoogleSheetsRow() {
    return [
      id,
      date?.toIso8601String() as String,
      bank,
